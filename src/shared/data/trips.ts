...
const rows:Brief[]=[
 ...
 {id:'trip-uji-nara',slug:'uji-nara-onsen',title:'奈良萌鹿、宇治古寺与温泉一日游',shortTitle:'奈良与宇治温泉',subtitle:'奈良公园、平等院、源氏物语与温泉',summary:'从奈良鹿群走进宇治世界遗产与抹茶街区，以温泉放松收尾。',description:'一天连接奈良公园、宇治平等院、源氏物语博物馆与天然温泉，兼顾古都文化、当地味觉和休息。',region:'奈良与京都宇治',duration:'约 10–11 小时',walkingLevel:'中等',categories:['经典人文','温泉'],heroImage:'/images/uji-nara.jpg',highlights:['奈良公园鹿群','平等院凤凰堂','宇治抹茶与温泉'],stops:['奈良公园','宇治平等院','源氏物语博物馆','宇治源氏之汤'],timeline:[['奈良公园','漫步古都公园并按现场规则与鹿互动。'],['宇治平等院','参观凤凰堂庭园与宇治历史街区。'],['源氏物语博物馆','从文学与影像了解宇治十帖。'],['宇治源氏之汤','自费入浴或在周边自由活动。']],sourceUrl:'https://www.gogoday.com/pages/dayTrip/index?id=176'},
 {id:'trip-miyama',slug:'miyama-katsuoji-arashiyama',title:'胜尾寺、爱宕念佛寺与岚山一日游',shortTitle:'胜尾寺与岚山',subtitle:'红色达摩、千姿罗汉与竹林光影',summary:'红色达摩、表情各异的石像和向上生长的竹林，把关西寺院与自然景观串进同一天。',description:'先在胜尾寺为正在努力的自己许愿，再到爱宕念佛寺寻找一尊让你微笑的罗汉，最后走进岚山竹林，让旅途从鲜明色彩过渡到清新绿意。',region:'大阪北部与京都岚山',duration:'约 10–11 小时',walkingLevel:'中等',categories:['自然风光','经典人文'],heroImage:'/images/miyama-katsuoji.jpg',highlights:['胜尾寺达摩与祈愿文化','爱宕念佛寺千姿罗汉','岚山竹林光影'],stops:['胜尾寺','爱宕念佛寺','岚山竹林'],timeline:[['胜尾寺','在达摩与庭园之间参拜，寻找属于自己的祈愿画面。'],['爱宕念佛寺','沿山间寺院欣赏表情各异的石雕罗汉。'],['岚山竹林','漫步竹林小径，在河岸与街区自由活动。']],sourceUrl:'https://www.gogoday.com/pages/dayTrip/index?id=293'},
 {id:'trip-hozugawa',slug:'arashiyama-train-hozugawa',title:'京都经典一日游',shortTitle:'京都经典',subtitle:'金色倒影、石板古街与千本鸟居',summary:'如果你心里的京都是古寺、町家和朱红鸟居，这条路线把几幅最令人向往的画面放进同一天。',description:'从金阁寺映在池水中的金色倒影出发，走进清水寺与二年坂、三年坂的古都街景，再穿过伏见稻荷大社的鸟居长廊，看见京都截然不同的几种表情。',region:'京都',duration:'约 9–10 小时',walkingLevel:'中等',categories:['经典人文'],heroImage:'/images/routes/kinkaku/kinkaku-01.webp',highlights:['金阁寺与镜湖池倒影','清水寺和东山石板古街','伏见稻荷千本鸟居'],stops:['金阁寺','清水寺','二年坂·三年坂','伏见稻荷大社'],timeline:[['金阁寺','沿镜湖池欣赏金色楼阁与庭园倒影。'],['清水寺','从清水舞台眺望京都，并沿东山历史街区散步。'],['二年坂·三年坂','在石板坡道与町家之间自由游览。'],['伏见稻荷大社','走进朱红鸟居长廊，为一天收尾。']],sourceUrl:'https://www.gogoday.com/pages/dayTrip/index?id=133'},
 {id:'trip-autumn',slug:'sanzenin-kibune-arashiyama-autumn',title:'红叶季限定：贵船、三千院与岚山一日游',shortTitle:'京都红叶三景',subtitle:'山间灯笼、苔庭红叶与岚山秋色',summary:'沿山间石阶走进贵船，在三千院寻找红叶与苔庭相映的画面，再到岚山欣赏河流与山色。',description:'为红叶季设计的京都纵贯路线：贵船神社的朱红灯笼开启山中秋日，三千院用苔庭与落叶呈现细腻色彩，最后在渡月桥前把京都秋色收入一幅开阔山水。',region:'京都 · 贵船、大原、岚山',duration:'约 10–11 小时',walkingLevel:'中等至较高',categories:['自然风光','经典人文'],heroImage:'/images/kyoto-autumn.jpg',highlights:['贵船神社灯笼石阶','三千院苔庭红叶','岚山渡月桥秋色'],stops:['贵船神社','大原三千院','岚山·渡月桥'],timeline:[['贵船神社','沿朱红灯笼石阶走进山间秋色。'],['大原三千院','在苔庭、往生极乐院与红叶林间慢行。'],['岚山·渡月桥','沿河岸欣赏渡月桥与山体层次丰富的秋色。']],sourceUrl:'https://www.gogoday.com/pages/dayTrip/index?id=300'}];
...
const routeImageCredits:Record<string,string[]>={
 'uji-nara-onsen':['Phoenix Hall, Byodo-in, November 2016 -01 · Wikimedia Commons · CC BY-SA 4.0 · https://commons.wikimedia.org/wiki/File:Phoenix_Hall,_Byodo-in,_November_2016_-01.jpg'],
 'miyama-katsuoji-arashiyama':['Kyoto r38 miyama-kayabuki.gfdl · Wikimedia Commons · CC BY-SA 3.0 · https://commons.wikimedia.org/wiki/File:Kyoto_r38_miyama-kayabuki.gfdl.jpg'],
 'arashiyama-train-hozugawa':['Hozugawa-Kudari 201126a · Wikimedia Commons · CC BY-SA 4.0 · https://commons.wikimedia.org/wiki/File:Hozugawa-Kudari_201126a.jpg'],
 'sanzenin-kibune-arashiyama-autumn':['Sanzen-in, Approach to Sanzen-in -1 (November 2014) · Wikimedia Commons · CC BY 3.0 · https://commons.wikimedia.org/wiki/File:Sanzen-in,_Approach_to_Sanzen-in_-1_(November_2014)_-_panoramio.jpg'],
};
export const trips:Trip[]=rows.map(r=>({...common,...r,price:publishedSeatPrices[r.slug]??null,priceStatus:publishedSeatPrices[r.slug]==null?'待公布':'每席含税',minimumGuests:1,seatStatus:publishedSeatPrices[r.slug]==null?'未开放':'未来30天每日开放',gallery:[r.heroImage],timeline:r.timeline.map(([title,detail])=>({time:null,title,detail,location:title})),imageCredits:routeImageCredits[r.slug]??['Japan Travel / 大寅集团提供的来源站素材']}));
