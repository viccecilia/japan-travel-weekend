...
export function DepartureMonthCalendar({month, departures, selectedRoute, selectedDeparture, openSelected = true, onRouteChange, onSelect}: {
  month: string;
