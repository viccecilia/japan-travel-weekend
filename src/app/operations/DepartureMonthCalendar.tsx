...
export function DepartureMonthCalendar({month, departures, selectedRoute, selectedDeparture, openSelected = true, onRouteChange, onSelect, onChangeVehicleGroup}: {
  month: string;
  ...
  onChangeVehicleGroup?: (departure: OperationsCalendarDeparture, vehicle: OperationsCalendarDeparture['vehicles'][number]) => void;
}) {
