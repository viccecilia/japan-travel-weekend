...
const normalizedTitleMap: Array<{test:(pathname:string,search:string)=>boolean;group:string;page:string}> = [
  {test:(pathname)=>pathname==='/app/operations/orders/charters',group:'订单与售后',page:'VIP包车需求'},
