...
begin;
do $$
declare v_account uuid;v_trip uuid;v_departure uuid;v_draft uuid;v_result record;v_retry record;v_key text:='draft-convert-'||txid_current()::text;v_status text;v_link uuid;v_hold_status text;
begin
