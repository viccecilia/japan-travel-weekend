#!/usr/bin/env bash
set -euo pipefail
bundle=/home/ubuntu/jtw-test-deploy-jtw-20260906-notification-i18n-v12
release=/var/www/jtw-test-releases/jtw-20260906-notification-i18n-v12
...
curl -fsS https://weekend.japan-travel.info/app/notifications >/dev/null
