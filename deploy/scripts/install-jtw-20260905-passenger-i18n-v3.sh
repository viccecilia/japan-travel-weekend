#!/usr/bin/env bash
set -euo pipefail
bundle=/home/ubuntu/jtw-test-deploy-jtw-20260905-passenger-i18n-v3
release=/var/www/jtw-test-releases/jtw-20260905-passenger-i18n-v3
...
curl -fsS https://weekend.japan-travel.info/app/support >/dev/null
curl -fsS https://weekend.japan-travel.info/app/checkout >/dev/null
