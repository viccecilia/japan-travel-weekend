#!/usr/bin/env bash
set -euo pipefail
bundle=/home/ubuntu/jtw-20260909-route-stories-v30
release=/var/www/jtw-test-releases/jtw-20260909-route-stories-v30
current=/var/www/japan-travel-weekend-test
test -s "$bundle/dist/index.html"
test -s "$bundle/dist/sw.js"
test -s "$bundle/dist/assets/index-D4Mb81mG.js"
