#!/usr/bin/env bash
set -euo pipefail
bundle=/home/ubuntu/jtw-20260909-referral-monitor-v26
release=/var/www/jtw-test-releases/jtw-20260909-referral-monitor-v26
...
curl -fsS https://weekend.japan-travel.info/app/referral >/dev/null
