#!/usr/bin/env bash
set -euo pipefail
bundle=/home/ubuntu/jtw-test-deploy-jtw-20260906-route-photos-v8
release=/var/www/jtw-test-releases/jtw-20260906-route-photos-v8
...
curl -fsS https://weekend.japan-travel.info/app/trips/kyoto-nara-classic >/dev/null
curl -fsS https://weekend.japan-travel.info/app/trips/wakayama-family >/dev/null
