#!/usr/bin/env bash
set -euo pipefail
bundle=/home/ubuntu/jtw-test-deploy-jtw-20260906-order-card-layout-v13
release=/var/www/jtw-test-releases/jtw-20260906-order-card-layout-v13
...
curl -fsS https://weekend.japan-travel.info/app/orders >/dev/null
