#!/usr/bin/env bash
set -euo pipefail
bundle=/home/ubuntu/jtw-test-deploy-jtw-20260905-passenger-i18n-v4
release=/var/www/jtw-test-releases/jtw-20260905-passenger-i18n-v4
...
curl -fsS https://weekend.japan-travel.info/app/trips >/dev/null
curl -fsS https://weekend.japan-travel.info/app/my-trip/room >/dev/null
curl -fsS https://weekend.japan-travel.info/app/profile >/dev/null
