#!/usr/bin/env bash
set -euo pipefail
bundle=/home/ubuntu/jtw-test-deploy-jtw-20260906-website-i18n-v10
release=/var/www/jtw-test-releases/jtw-20260906-website-i18n-v10
...
curl -fsS https://weekend.japan-travel.info/legal/terms >/dev/null
