#!/usr/bin/env bash
set -euo pipefail
bundle=/home/ubuntu/jtw-20260909-passenger-boundary-v31
release=/var/www/jtw-test-releases/jtw-20260909-passenger-boundary-v31
current=/var/www/japan-travel-weekend-test
test -s "$bundle/dist/index.html"
test -s "$bundle/dist/sw.js"
test -s "$bundle/dist/assets/index-CZ6HWULX.js"
