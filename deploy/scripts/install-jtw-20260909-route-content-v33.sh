#!/usr/bin/env bash
set -euo pipefail
bundle=/home/ubuntu/jtw-20260909-route-content-v33
release=/var/www/jtw-test-releases/jtw-20260909-route-content-v33
current=/var/www/japan-travel-weekend-test
test -s "$bundle/dist/index.html"
test -s "$bundle/dist/sw.js"
test -s "$bundle/dist/assets/index-u7Sm0L_a.js"
test -s "$bundle/dist/images/routes/kinkaku/kinkaku-01.webp"
...
for path in /app/trips /app/trips/arashiyama-train-hozugawa /app/booking/arashiyama-train-hozugawa /staff /app/operations; do curl -fsS "https://weekend.japan-travel.info$path" >/dev/null; done
