...
测试服务栈已批准为 Supabase + Stripe + Google Maps Platform。Supabase 远程测试项目已执行至 010 迁移；虚构账户、RLS、测试 Webhook 与浏览器 100 日元 Stripe 测试卡流程均已验收。配置变量见 `.env.example`，操作与安全边界见 `docs/approved-test-service-stack.md`。
